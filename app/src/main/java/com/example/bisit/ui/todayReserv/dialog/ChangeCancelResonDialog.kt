...
class ChangeCancelReasonDialog : DialogFragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.dialog_cancel_reason, container, false)
        ...
        btnSubmit.setOnClickListener {
            dismiss()
            CancelCompleteDialog().show(parentFragmentManager, "cancel_complete")
        }
