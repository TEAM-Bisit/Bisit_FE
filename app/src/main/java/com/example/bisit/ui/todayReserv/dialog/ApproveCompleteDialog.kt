...
class ApproveCompleteDialog(
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.dialog_approve_complete, container, false)

        val btnConfirm = view.findViewById<Button>(R.id.btnSubmit)
