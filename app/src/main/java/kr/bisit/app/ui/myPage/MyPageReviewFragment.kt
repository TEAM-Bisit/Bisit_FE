...
class MyPageReviewFragment : Fragment() {
    ...
    private fun showEditDialog(review: ReviewDetailItem) {
        ...
        btnSummit.setOnClickListener {
            ...
            val request = kr.bisit.app.data.model.review.ReviewUpdateRequest(currentScore, content)
