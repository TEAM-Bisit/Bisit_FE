...
import kr.bisit.app.databinding.FragmentMyPageOwnerEditBinding
import kr.bisit.app.data.model.member.MyProfileResponse
import kr.bisit.app.data.model.member.MemberUpdateRequest
import kr.bisit.app.data.model.member.MemberUpdateResponse
...
class MyPageOwnerEditFragment : Fragment() {
    ...
    private fun sendSms(phone: String) {
        ...
        smsApi.sendSms(mapOf("phoneNumber" to phone))
            .enqueue(object : Callback<kr.bisit.app.data.model.mypage.SmsResponse> {

                override fun onResponse(
                    call: Call<kr.bisit.app.data.model.mypage.SmsResponse>,
                    response: Response<kr.bisit.app.data.model.mypage.SmsResponse>
                ) {
                    Log.d(
                        "SMS_DEBUG",
    ...
    private fun verifySms(phone: String, code: String) {
        ...
        smsApi.verifySms(
            ...
            Callback<kr.bisit.app.data.model.mypage.SmsVerifyResponse> {

            override fun onResponse(
                call: Call<kr.bisit.app.data.model.mypage.SmsVerifyResponse>,
                response: Response<kr.bisit.app.data.model.mypage.SmsVerifyResponse>
            ) {
