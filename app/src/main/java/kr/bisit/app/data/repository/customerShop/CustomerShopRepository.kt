package kr.bisit.app.data.repository.customerShop

import android.content.Context
import kr.bisit.app.data.model.customerShop.*
...
class CustomerShopRepository(context: Context) {
    ...
    fun getShopReviews(context: Context, shopId: Long, page: Int, size: Int): retrofit2.Call<kr.bisit.app.data.model.review.ReviewListResponse> {
